...
export const LedgerWidget = () => {
  ...
  const tableDefinition=[
    ...
    },
    {
      ...
      label:'Kategoria',
      renderCell: (row) => (
        <CategoryCell color={row.category?.color} name={row.categorys?.name} /> 
    )
    },
    {
      id: 'createdAt',
    ...
    <Card
        title={
          <ActionHeader
            ...
            renderActions={() => 
              <Box>
            <Button startIcon variant={'contained'}>Wpłac</Button>
            <Button startIcon variant={'contained'}>Wyplac -</Button>
